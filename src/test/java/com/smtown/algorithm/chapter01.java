...
public class chapter01 {
	private static String userId = "Administrator@smtown.com";
	private static String passwd = "dlsvmfk!!^^@)!&";
	private static String ldapDomain = "10.10.12.6:389";
	...
	public static void main(String[] args) {
		...
		try {
			...
			NamingEnumeration<SearchResult> results = context.search(
					"OU=SMTown_users,OU=SMTown,DC=smtown,DC=com", filterString, searcher);
