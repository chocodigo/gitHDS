...
import com.smtown.smhds.faq.FaqMapper;
...
public class FaqService {
    ...
    //자동완성
    public List<String> faqSuggestionService(PrintPage printPage) throws Exception{
        return faqMapper.faqSuggestion(printPage);
    }
