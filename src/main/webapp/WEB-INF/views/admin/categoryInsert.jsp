...
<div class="table_box">
    <form id="insert_form" action="/admin/categoryInsertProc" method="post" enctype="multipart/form-data">
        <table>
            <colgroup>
                <col width="15%">
                <col width="20%">
            ...
            <tbody>
                <tr>
                    <td>코드</td>
                    <td><input type="text" class="form-control" id="comm_code" name="comm_code"></td>
                    <td>코드는 두 자리의 숫자로만 입력해주세요. 예) 01</td>
                </tr>
                <tr>
                    <td>카테고리 이름</td>
                    <td colspan="2"><input type="text" class="form-control" id="code_name" name="code_name"></td>
                </tr>
                <tr>
                    <td>담당자 이메일</td>
                    <td colspan="2"><input type="text" class="form-control" id="admi_mail" name="admi_mail"></td>
                </tr>
