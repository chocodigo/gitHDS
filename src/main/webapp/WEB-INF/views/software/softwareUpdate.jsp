...
/***************************************************************************************************
 * # Program: 	softwareUpdate.jsp 자료실 게시글 수정 및 업데이트 페이지
 *
  ...
  function software_update(){
 	 var titl_name = $("#titl_name").val();	//글 제목
 	  ...
 	  if(titl_name == ""){
          ...
          $("#update_form").submit();
          ajaxJsonCallSync("/software_list", data, softwareSuccessCallBack, "${_csrf.headerName}", "${_csrf.token}");     //faq 목록으로 이동
      }
      else{}
 }
...
<div class="table_box">
    ...
    <form id="update_form" action="/software_updateProc" method="post" enctype="multipart/form-data">
        <table>
            <colgroup>
                <col width="15%">
                <col width="85%" >
    ...
    <div class="insert_btn">
        <button type="button" class="btn" onclick="software_update();">수정</button>
    </div>
