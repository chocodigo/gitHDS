...
/***************************************************************************************************
 * # Program: 	NoticeUpdate.jsp 공지사항 게시글 수정 및 업데이트 페이지
 * 
    ...
    <form id="update_form" action="/notice_updateProc" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tbody>
                <tr>
                    <td>제목</td>
                    <td><input type="text" class="form-control" id="titl_name" name="titl_name" maxlength="50" value="${detail.titl_name}"></td>
                </tr>
                <tr>
                    <td>작성자</td>
