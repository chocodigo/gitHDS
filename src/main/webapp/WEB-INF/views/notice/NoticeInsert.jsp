...
<div class="table_box">
    <form id="insert_form" action="/noticeInsertProc" method="post" enctype="multipart/form-data">
        <table>
            <colgroup>
                <col width="15%">
                <col width="85%" >
            ...
            <tbody>
                <tr>
                    <td>제목</td>
                    <td><input type="text" class="form-control" id="titl_name" name="titl_name" maxlength="50"></td>
                </tr>
                <tr>
                    <td>작성자</td>
                    <td>${real_name}</td>
