...
/***************************************************************************************************
 * # Program: 	NoticeInsert.jsp 공지사항 입력 페이지
 * 
...
<div class="container" style="width: 100%; margin-top: 90px;">
	<div class="mdl-card__title" style="height:60px;">
		...
		<h2 class="mdl-card__title-text" style="display: inline-block;">공지사항 작성</h2>
	</div>
	<div class="mdl-card__supporting-text" style="width: 100%; font-size: 12px;">
		<form id="insert_form" class="form-group" action="/noticeInsertProc" method="post" enctype="multipart/form-data">
		...
		<div class="detail_btn_group">
			...
			<button type="button" class="mdl-button mdl-js-button" onclick="location.href='/notice_list'">목록</button>
		</div>
	</div>
</div>
</body>
